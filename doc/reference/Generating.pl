...
@tt{ascii}, @tt{html}, @tt{info}, @tt{manl}, ...) in which
...
several paper sizes for the printable outputs (@tt{pdf}). The
...
defined. @tt{lpdoc html}, @tt{lpdoc pdf}, or @tt{lpdoc
...
% NOTE: This part is obsolete. LPdoc does not generate dvi.
%
